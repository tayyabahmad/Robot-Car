...
public class MainActivity extends AppCompatActivity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		listView.setOnItemClickListener(new AdapterView.OnItemClickListener()
		{
			...
			{
				TextView textView = (TextView) view.findViewById(R.id.camera_address);

				if(textView == null){
					Toast.makeText(MainActivity.this, "textView-camera_address is null", Toast.LENGTH_SHORT).show();
					return;
				}
				startVideoActivity(adapter.getCameras().get(position), textView.getText().toString().trim());
			}
		});
	...
	// startVideoActivity
	//******************************************************************************
	private void startVideoActivity(Camera camera, String ipAddress) {
